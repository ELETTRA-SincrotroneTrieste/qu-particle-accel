...
QuSvgComponentLoader::QuSvgComponentLoader(const QString &fnam, const QString& id) {
    m_id = id;
...
QuSvgComponentLoader::QuSvgComponentLoader(const QString& id) : m_id(id) {
